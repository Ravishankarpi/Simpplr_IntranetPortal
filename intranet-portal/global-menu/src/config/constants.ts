...
export const ENABLE_GLOBAL_ACROSS_TENANT = process.env.ENABLE_GLOBAL_NAVIGATION_ACROSS_TENANT;  // When false, the extension only loads on ROOT_SITE_URL;
export const ENABLE_GLOBAL_SCSS_ACROSS_TENANT = process.env.ENABLE_GLOBAL_SCSS_ACROSS_TENANT;
