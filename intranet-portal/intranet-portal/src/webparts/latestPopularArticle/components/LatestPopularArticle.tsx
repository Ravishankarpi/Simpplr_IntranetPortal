...
export default class LatestPopularArticle extends React.Component<ILatestPopularArticleProps> {
  public render(): React.ReactElement<ILatestPopularArticleProps> {
    ...
    return (
      <section className={`${styles.latestPopularArticle} ${hasTeamsContext ? styles.teams : ''}`}>
