...
export default class CarouselArticle extends React.Component<ICarouselArticleProps> {
  public render(): React.ReactElement<ICarouselArticleProps> {
    ...
    return (
      <section className={`${styles.carouselArticle} ${hasTeamsContext ? styles.teams : ''}`}>
